module.exports = Object.freeze({
    // COP IDS:
    COPfront1: 1536, // x600 = front 1
    COPfront2: 1537, // x601 = front 2
    COPrear1: 1538, // x602 = rear 1
    ...
    PCAN_ERROR_BUSWARNING: this.PCAN_ERROR_BUSWARNING, // Bus error: an error counter reached the 'warning' limit
    ...
    PCAN_ERROR_ANYBUSERR: (this.PCAN_ERROR_BUSWARNING || this.PCAN_ERROR_BUSLIGHT || this.PCAN_ERROR_BUSHEAVY || this.PCAN_ERROR_BUSOFF || this.PCAN_ERROR_BUSPASSIVE), // Mask for all b
    ...
    PCAN_ERROR_ILLHANDLE: (this.PCAN_ERROR_ILLHW || this.PCAN_ERROR_ILLNET || this.PCAN_ERROR_ILLCLIENT), // Mask for all handle errors
    ...
    PCAN_CHANNEL_AVAILABLE: '0x01U', // The PCAN-Channel handle is available to be connected (Plug&Play Hardware: it means furthermore that the hardware is p
    PCAN_CHANNEL_OCCUPIED: '0x02U', // The PCAN-Channel handle is valid, and is already being used
    PCAN_CHANNEL_PCANVIEW: (this.PCAN_CHANNEL_AVAILABLE || this.PCAN_CHANNEL_OCCUPIED), // The PCAN-Channel handle is already being used by a PCAN-View application,
